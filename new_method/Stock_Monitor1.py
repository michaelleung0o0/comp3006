...
class About_Us ( wx.Frame ):
	...
	def __init__( self, parent ):
		...
		self.m_richText3 = wx.richtext.RichTextCtrl( self.m_panel11, wx.ID_ANY, aboutUSText, wx.DefaultPosition, wx.DefaultSize, wx.TE_READONLY|wx.VSCROLL|wx.HSCROLL|wx.NO_BORDER|wx.WANTS_CHARS )
